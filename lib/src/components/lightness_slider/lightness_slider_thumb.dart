...
/// The [LightnessSliderThumb] is a custom version of [RoundSliderThumbShape]
...
class LightnessSliderThumb extends RoundSliderThumbShape {
  /// Create a slider thumb that draws a circle filled with [color]
  /// and shows the slider `value` * 100 in the thumb.
  const LightnessSliderThumb({
    required this.color,
    double enabledThumbRadius = lightnessThumbRadius,
